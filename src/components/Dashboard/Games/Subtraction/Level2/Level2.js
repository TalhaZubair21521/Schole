    ...
    return (
        <div>
            ...
            <div style={mainDivHomepage}>
                <div className="row" >
                    <div className="col-6" style={{ marginTop: "-3%" }}>
                        <div style={CenterContent}>
                            <div style={{backgroundColor:"#FFFFFF",border:"3px solid red",borderRadius: "5px",padding:"2% 5%",textAlign:"center"}}>
                                <h1>8</h1>
                            </div>
                ...
                <div style={block}>
                                    <button type="button" style={{ ...btn, color: 'orange', borderColor: "orange" }} onClick={() => history.push('/dashboard/games/subtraction/level3')}>Don't Know</button><br />
                                    <button type="button" style={{ ...btn, color: 'red', borderColor: "red" }} onClick={() => window.location.reload(false)}>Clear</button><br />
                                    <button type="button" style={{ ...btn, color: 'green', borderColor: "green" }} onClick={() => history.push('/dashboard/games/subtraction/level3')}>Submit</button>
                        </div>
            </div>
        </div>
    );
