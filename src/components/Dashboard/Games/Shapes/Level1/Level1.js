  ...
  const shapes = [
    {
      id: "0",
      name: "Triangle",
      text: "I have three sides and are sharp.What am I?",
    },
    {
      id: "1",
      name: "Square",
      text: "I have four sides and are equal.What am I?",
    },
    {
      id: "2",
      name: "Rectangle",
      text: "I have two long sides and two short sides.What am I?",
    },
    {
      id: "3",
      name: "Circle",
      text: "I have no sides, same from everywhere.What am I?",
    },
  ];
        ...
        <div className="row">
          ...
          <div className="col-4" style={{ marginTop: "-5%" }}>
            <div style={CenterContent}>
              <div style={FrameBackgroundImageSetter}>
                <div
                  className="row"
                  style={{ marginTop: "10%", color: "#C84747" }}
                >
          ...
          <div style={block}>
            <button
              ...
              onClick={() => history.push("/dashboard/games/shapes/level2")}
            >
              Don't Know
            </button>
            <br />
