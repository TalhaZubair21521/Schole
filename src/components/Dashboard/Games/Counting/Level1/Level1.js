...
const Level1 = (props) => {
  ...
  let points = 0;
  const ballons = [
    { number: 10, src: Ballon1 },
    { number: 8, src: Ballon2 },
    { number: 6, src: Ballon3 },
    { number: 4, src: Ballon4 },
    { number: 2, src: Ballon5 },
  ];
  const [ballonImages, setballonImages] = useState(ballons);
  const cards = [
    { id: 1, type: "empty", src: "", number: 0 },
    { id: 2, type: "empty", src: "", number: 0 },
    { id: 3, type: "empty", src: "", number: 0 },
    { id: 4, type: "empty", src: "", number: 0 },
    { id: 5, type: "empty", src: "", number: 0 },
  ];
  ...
  const evaluateResult = () => {
    const completed =
      cardImages.filter((card) => card.type === "empty").length !== 0;
    if (completed) {
  ...
  const updateLocation = (id, cardId) => {
    play();
    setPlayOtion(true);
    const newBallonsList = ballonImages.filter(
      (ballon) => ballon.number !== id
    );
              ...
              <div style={{ marginTop: "-20px" }}>
                <div className="row">
                  <div className="col-3" onDrag={Play}>
                    {ballonImages.filter((ballon) => ballon.number === 10)
                      .length !== 0 ? (
                  ...
                  <div className="col-3" />
                  <div className="col-3" onDrag={Play}>
                    {ballonImages.filter((ballon) => ballon.number === 8)
                      .length !== 0 ? (
                ...
                <div className="row">
                  <div className="col-1" />
                  <div className="col-5">
                    {ballonImages.filter((ballon) => ballon.number === 6)
                      .length !== 0 ? (
                  ...
                  <div className="col-3">
                    {ballonImages.filter((ballon) => ballon.number === 4)
                      .length !== 0 ? (
                ...
                <div className="row">
                  <div className="col-3">
                    {ballonImages.filter((ballon) => ballon.number === 2)
                      .length !== 0 ? (
            ...
            <div style={CenterContent}>
              <div style={BackgroundImageSetter}>
                <div style={{ marginTop: "40px" }}>
                  ...
                  >
                    Drop Here In Ascending Order from Left to Right
                  </div>
                  <div className="row">
                    <div className="col-2" />
                    <div className="col-4">
