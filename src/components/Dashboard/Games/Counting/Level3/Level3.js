                    ...
                    <div style={BackgroundImageSetter}>
                        <div className="row" style={{ marginTop: "10%" }}>
                            ...
                            <div className="col-10">
                                <h2 style={{ color: "#C84747", fontWeight: "bold" }}>Arrange The Lollipop In Order</h2>
                            </div>
                            <div className="container" style={{ marginLeft: "160px" }}>
                                <div className="row">
                                    <div className="col-2">
                                        <BackgroundCard id={images[0].id} backgroundSrc={CardImage} imageSrc={images[0].src} replaceImages={replaceImages} />
                                    </div>
                                    <div className="col-2">
                                        <BackgroundCard id={images[1].id} backgroundSrc={CardImage} imageSrc={images[1].src} replaceImages={replaceImages} />
                                    </div>
                                    <div className="col-2">
                                        <BackgroundCard id={images[2].id} backgroundSrc={CardImage} imageSrc={images[2].src} replaceImages={replaceImages} />
                                    </div>
                                    <div className="col-2">
                                        <BackgroundCard id={images[3].id} backgroundSrc={CardImage} imageSrc={images[3].src} replaceImages={replaceImages} />
                                    </div>
                                    <div className="col-2">
                                        <BackgroundCard id={images[4].id} backgroundSrc={CardImage} imageSrc={images[4].src} replaceImages={replaceImages} />
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-2">
                                        <BackgroundCard id={images[5].id} backgroundSrc={CardImage} imageSrc={images[5].src} replaceImages={replaceImages} />
                                    </div>
                                    <div className="col-2">
                                        <BackgroundCard id={images[6].id} backgroundSrc={CardImage} imageSrc={images[6].src} replaceImages={replaceImages} />
                                    </div>
                                    <div className="col-2">
                                        <BackgroundCard id={images[7].id} backgroundSrc={CardImage} imageSrc={images[7].src} replaceImages={replaceImages} />
                                    </div>
                                    <div className="col-2">
                                        <BackgroundCard id={images[8].id} backgroundSrc={CardImage} imageSrc={images[8].src} replaceImages={replaceImages} />
                                    </div>
                                    <div className="col-2">
                                        <BackgroundCard id={images[9].id} backgroundSrc={CardImage} imageSrc={images[9].src} replaceImages={replaceImages} />
                                    </div>
                                </div>
                            </div>
                        </div>
