...
const Level2 = () => {
  ...
  const ballons = [
    { id: 0, src: Ball1, number: 5 },
    { id: 1, src: Ball2, number: 10 },
    { id: 2, src: Ball3, number: 15 },
    { id: 3, src: Ball4, number: 20 },
    { id: 4, src: Ball5, number: 25 },
    { id: 5, src: Ball6, number: 30 },
    { id: 6, src: Ball7, number: 35 },
    { id: 7, src: Ball8, number: 40 },
    { id: 8, src: Ball9, number: 45 },
    { id: 9, src: Ball10, number: 50 },
  ];
        ...
        <div style={CenterContent}>
          <div style={BackgroundImageSetter}>
            <div className="row" style={{ marginTop: "8%" }}>
              ...
              >
                <p style={{ color: "#C84747" }}>
                  Throw The Highlight Number Ball on the Hoop
                </p>
              </div>
            </div>
            <div className="row" style={{ marginLeft: "14%", marginTop: "0%" }}>
              <div className="col-2">
                {ballonsImages.filter((ballon) => ballon.number === 5)
                  .length !== 0 ? (
              ...
              <div className="col-2">
                {ballonsImages.filter((ballon) => ballon.number === 10)
                  .length !== 0 ? (
              ...
              <div className="col-2">
                {ballonsImages.filter((ballon) => ballon.number === 15)
                  .length !== 0 ? (
              ...
              <div className="col-2">
                {ballonsImages.filter((ballon) => ballon.number === 20)
                  .length !== 0 ? (
              ...
              <div className="col-2">
                {ballonsImages.filter((ballon) => ballon.number === 25)
                  .length !== 0 ? (
            ...
            >
              <div className="col-2">
                {ballonsImages.filter((ballon) => ballon.number === 30)
                  .length !== 0 ? (
              ...
              <div className="col-2">
                {ballonsImages.filter((ballon) => ballon.number === 35)
                  .length !== 0 ? (
              ...
              <div className="col-2">
                {ballonsImages.filter((ballon) => ballon.number === 40)
                  .length !== 0 ? (
              ...
              <div className="col-2">
                {ballonsImages.filter((ballon) => ballon.number === 45)
                  .length !== 0 ? (
              ...
              <div className="col-2">
                {ballonsImages.filter((ballon) => ballon.number === 50)
                  .length !== 0 ? (
            ...
            <div className="row" style={{ marginTop: "5%" }}>
              ...
              >
                <DropImage
                  imageSrc={Hoop}
                  updateBallonImages={updateBallonImages}
                />
              </div>
            </div>
            <div
              className="row"
              style={{ marginTop: "2%", paddingLeft: "14%" }}
            >
